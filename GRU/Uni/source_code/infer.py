...
with tf.Session(graph=loaded_graph) as sess:
    ...
    # Remove tokens
    write_file="./data_check/data.txt"  ### file name
    writer_fl=open(write_file,"a")      ### open in append mode
    ...
    quote_script = quote_script.replace('( ', '(')
    writer_fl.write(quote_script)    
    print(quote_script) ### write
    writer_fl.close()   ### close file
